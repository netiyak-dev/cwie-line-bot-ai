...
1. **ห้ามเก็บข้อมูลที่ระบุตัวตนได้** — ไม่มีชื่อ เบอร์โทร หรือ LINE ID (**ยกเว้น** LINE ID เก็บได้เมื่อนักศึกษา opt-in follow-up อย่างชัดแจ้ง) รหัสนักศึกษาต้องเข้ารหัสด้วย HMAC-SHA256 เสมอ
2. **ระบบเก็บผลประเมินรายบุคคล** ได้ (linked กับ hashed student ID) เพื่อติดตามพัฒนาการ — consent ต้องแจ้งวัตถุประสงค์นี้ชัดเจน + นักศึกษามีสิทธิ์ขอลบข้อมูลได้
3. **ต้องแสดง PDPA consent ก่อนเก็บข้อมูลทุกครั้ง** — consent text ต้องระบุวัตถุประสงค์และสิทธิ์ของนักศึกษา
4. **ห้าม Admin เห็นผลประเมินรายบุคคล** — ดูได้เฉพาะ aggregate / export anonymized เท่านั้น (privacy by design)
