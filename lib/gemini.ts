...
/** คำตอบมาตรฐานเมื่อไม่มีข้อมูล / ตอบไม่ครบ */
export const DEFAULT_REPLY =
  "ขอบคุณที่ทักมานะคะ เรื่องนี้ยังไม่มีข้อมูลในระบบตอนนี้ รบกวนสอบถามอาจารย์ที่ปรึกษาโครงงาน หรือแวะมาที่ห้องการศึกษาได้เลยนะคะ เดี๋ยวพี่ช่วยดูให้ค่ะ 🙏";

/** ใช้เมื่อระบบ AI ขัดข้องชั่วคราว (503/overloaded) — ไม่ใช่ว่าไม่มีข้อมูล */
export const SYSTEM_BUSY_REPLY =
  "ขอโทษนะคะ ตอนนี้ระบบมีคนใช้งานเยอะนิดหน่อย รบกวนลองถามใหม่อีกครั้งสักครู่นะคะ 🙏";
...
function buildPrompt(question: string, faq: string): string {
  return `<role>
คุณคือ "AGSP" ผู้ช่วยดูแลรายวิชา Senior Project (KAAG474)
ทำหน้าที่ตอบคำถามนักศึกษาเกี่ยวกับการทำโครงงานวิจัย/Senior Project
</role>
